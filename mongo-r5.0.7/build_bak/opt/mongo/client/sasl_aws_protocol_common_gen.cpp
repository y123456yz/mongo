...
AwsClientFirst::AwsClientFirst() : _nonce(mongo::idl::preparsedValue<decltype(_nonce)>()), _gs2_cb_flag(mongo::idl::preparsedValue<decltype(_gs2_cb_flag)>()), _hasNonce(false), _hasGs2_cb_flag(false) {
...
AwsClientFirst AwsClientFirst::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<AwsClientFirst>();
...
AwsServerFirst::AwsServerFirst() : _serverNonce(mongo::idl::preparsedValue<decltype(_serverNonce)>()), _stsHost(mongo::idl::preparsedValue<decltype(_stsHost)>()), _hasServerNonce(false), _hasStsHost(false) {
    // Used for initialization only
}
...
AwsServerFirst AwsServerFirst::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<AwsServerFirst>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
AwsClientSecond::AwsClientSecond() : _authHeader(mongo::idl::preparsedValue<decltype(_authHeader)>()), _xAmzDate(mongo::idl::preparsedValue<decltype(_xAmzDate)>()), _hasAuthHeader(false), _hasXAmzDate(false) {
    // Used for initialization only
}
...
AwsClientSecond AwsClientSecond::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<AwsClientSecond>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}

...
// #undef MONGO_CONFIG_HAVE_EXPLICIT_BZERO
...
#define MONGO_CONFIG_OCSP_STAPLING_ENABLED 1
...
#define MONGO_CONFIG_USDT_ENABLED 1

// Set to which provider defines USDT
#define MONGO_CONFIG_USDT_PROVIDER SDT

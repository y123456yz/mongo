...
public:
     ...
     */
    const boost::optional<StringData> getApiVersion() const& { return boost::optional<StringData>{_apiVersion}; }
    void getApiVersion() && = delete;
     ...
     */
    const boost::optional<bool> getApiStrict() const& { return _apiStrict; }
    void getApiStrict() && = delete;
     ...
     */
    const boost::optional<bool> getApiDeprecationErrors() const& { return _apiDeprecationErrors; }
    void getApiDeprecationErrors() && = delete;

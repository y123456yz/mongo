...
constexpr StringData kAccessCheck_kGetAuthenticatedUserNames = "get_authenticated_user_names"_sd;
constexpr StringData kAccessCheck_kGetImpersonatedRoleNames = "get_impersonated_role_names"_sd;
constexpr StringData kAccessCheck_kGetImpersonatedUserNames = "get_impersonated_user_names"_sd;
constexpr StringData kAccessCheck_kGetSingleUser = "get_single_user"_sd;
...
AccessCheckEnum AccessCheck_parse(const IDLParserErrorContext& ctxt, StringData value) {
    ...
    if (value == kAccessCheck_kGetAuthenticatedUserNames) {
        return AccessCheckEnum::kGetAuthenticatedUserNames;
    }
    if (value == kAccessCheck_kGetImpersonatedRoleNames) {
        return AccessCheckEnum::kGetImpersonatedRoleNames;
    }
    if (value == kAccessCheck_kGetImpersonatedUserNames) {
        return AccessCheckEnum::kGetImpersonatedUserNames;
    }
    if (value == kAccessCheck_kGetSingleUser) {
        return AccessCheckEnum::kGetSingleUser;
    }
...
StringData AccessCheck_serializer(AccessCheckEnum value) {
    ...
    if (value == AccessCheckEnum::kGetAuthenticatedUserNames) {
        return kAccessCheck_kGetAuthenticatedUserNames;
    }
    if (value == AccessCheckEnum::kGetImpersonatedRoleNames) {
        return kAccessCheck_kGetImpersonatedRoleNames;
    }
    if (value == AccessCheckEnum::kGetImpersonatedUserNames) {
        return kAccessCheck_kGetImpersonatedUserNames;
    }
    if (value == AccessCheckEnum::kGetSingleUser) {
        return kAccessCheck_kGetSingleUser;
    }

...
bool gEnforceUserClusterSeparation{true};
MONGO_SERVER_PARAMETER_REGISTER(idl_bc61ef02ecf5881e52820dcd513438ce23b48d27)(InitializerContext*) {
    ...
    /**
     * Prevents creation of users whose names would be interpreted as cluster members
     */
    [[maybe_unused]] auto* scp_1 = ([]() -> ServerParameter* {
        auto* ret = makeIDLServerParameterWithStorage<ServerParameterType::kStartupOnly>("enforceUserClusterSeparation", gEnforceUserClusterSeparation);
        return ret;
    })();

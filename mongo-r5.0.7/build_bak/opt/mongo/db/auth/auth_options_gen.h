...
constexpr auto kRoleGraphInvalidationIsFatalDefault = false;

extern bool roleGraphInvalidationIsFatal;
constexpr auto kEnforceUserClusterSeparationDefault = true;

extern bool gEnforceUserClusterSeparation;
}  // namespace mongo

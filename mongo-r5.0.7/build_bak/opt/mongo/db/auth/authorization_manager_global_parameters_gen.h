...
public:
    AuthzVersionParameter(StringData name, ServerParameterType spt);
...
constexpr auto kStartupAuthSchemaValidationDefault = true;

extern bool gStartupAuthSchemaValidation;
constexpr auto kAllowRolesFromX509CertificatesDefault = true;

extern bool allowRolesFromX509Certificates;
}  // namespace mongo

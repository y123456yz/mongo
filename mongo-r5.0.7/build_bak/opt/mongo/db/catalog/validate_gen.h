...
constexpr auto kMaxValidateMBperSecDefault = 0;

extern AtomicWord<int> gMaxValidateMBperSec;
constexpr auto kMaxValidateMemoryUsageMBDefault = 200;

extern AtomicWord<int> maxValidateMemoryUsageMB;
}  // namespace mongo

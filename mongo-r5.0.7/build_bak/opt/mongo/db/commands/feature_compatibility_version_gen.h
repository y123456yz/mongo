...
public:
    FeatureCompatibilityVersionParameter(StringData name, ServerParameterType spt);
...
constexpr auto kInternalValidateFeaturesAsPrimaryDefault = true;

extern bool gInternalValidateFeaturesAsPrimary;
}  // namespace mongo

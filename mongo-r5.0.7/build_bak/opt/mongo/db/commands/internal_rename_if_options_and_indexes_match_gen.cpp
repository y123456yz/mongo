...
InternalRenameIfOptionsAndIndexesMatch::InternalRenameIfOptionsAndIndexesMatch() : _from(mongo::idl::preparsedValue<decltype(_from)>()), _to(mongo::idl::preparsedValue<decltype(_to)>()), _collectionOptions(mongo::idl::preparsedValue<decltype(_collectionOptions)>()), _hasFrom(false), _hasTo(false), _hasCollectionOptions(false), _hasIndexes(false), _hasDbName(false) {
...
InternalRenameIfOptionsAndIndexesMatch InternalRenameIfOptionsAndIndexesMatch::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<InternalRenameIfOptionsAndIndexesMatch>();

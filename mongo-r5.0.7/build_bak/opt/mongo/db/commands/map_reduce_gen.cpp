...
constexpr StringData MapReduceCommandRequest::kBypassDocumentValidationFieldName;
constexpr StringData MapReduceCommandRequest::kCollationFieldName;
constexpr StringData MapReduceCommandRequest::kDbNameFieldName;
constexpr StringData MapReduceCommandRequest::kFinalizeFieldName;
constexpr StringData MapReduceCommandRequest::kJsModeFieldName;
constexpr StringData MapReduceCommandRequest::kLimitFieldName;
constexpr StringData MapReduceCommandRequest::kMapFieldName;
constexpr StringData MapReduceCommandRequest::kOutOptionsFieldName;
constexpr StringData MapReduceCommandRequest::kQueryFieldName;
constexpr StringData MapReduceCommandRequest::kReduceFieldName;
constexpr StringData MapReduceCommandRequest::kScopeFieldName;
constexpr StringData MapReduceCommandRequest::kSortFieldName;
constexpr StringData MapReduceCommandRequest::kVerboseFieldName;
constexpr StringData MapReduceCommandRequest::kCommandName;

const std::vector<StringData> MapReduceCommandRequest::_knownBSONFields {
    MapReduceCommandRequest::kBypassDocumentValidationFieldName,
    MapReduceCommandRequest::kCollationFieldName,
    MapReduceCommandRequest::kFinalizeFieldName,
    MapReduceCommandRequest::kJsModeFieldName,
    MapReduceCommandRequest::kLimitFieldName,
    MapReduceCommandRequest::kMapFieldName,
    MapReduceCommandRequest::kOutOptionsFieldName,
    MapReduceCommandRequest::kQueryFieldName,
    MapReduceCommandRequest::kReduceFieldName,
    MapReduceCommandRequest::kScopeFieldName,
    MapReduceCommandRequest::kSortFieldName,
    MapReduceCommandRequest::kVerboseFieldName,
    MapReduceCommandRequest::kCommandName,
};
const std::vector<StringData> MapReduceCommandRequest::_knownOP_MSGFields {
    MapReduceCommandRequest::kBypassDocumentValidationFieldName,
    MapReduceCommandRequest::kCollationFieldName,
    MapReduceCommandRequest::kDbNameFieldName,
    MapReduceCommandRequest::kFinalizeFieldName,
    MapReduceCommandRequest::kJsModeFieldName,
    MapReduceCommandRequest::kLimitFieldName,
    MapReduceCommandRequest::kMapFieldName,
...
MapReduceCommandRequest::MapReduceCommandRequest(const NamespaceString nss) : _nss(std::move(nss)), _map(mongo::idl::preparsedValue<decltype(_map)>()), _reduce(mongo::idl::preparsedValue<decltype(_reduce)>()), _outOptions(mongo::idl::preparsedValue<decltype(_outOptions)>()), _dbName(nss.db().toString()), _hasMap(false), _hasReduce(false), _hasOutOptions(false), _hasDbName(true) {
...
MapReduceCommandRequest MapReduceCommandRequest::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    NamespaceString localNS;
    MapReduceCommandRequest object(localNS);
    object.parseProtected(ctxt, bsonObject);
    return object;
}
void MapReduceCommandRequest::parseProtected(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
...
MapReduceCommandRequest MapReduceCommandRequest::parse(const IDLParserErrorContext& ctxt, const OpMsgRequest& request) {
    NamespaceString localNS;
    MapReduceCommandRequest object(localNS);
    object.parseProtected(ctxt, request);
    return object;
}
void MapReduceCommandRequest::parseProtected(const IDLParserErrorContext& ctxt, const OpMsgRequest& request) {
    std::bitset<13> usedFields;
    const size_t kMapBit = 0;
    const size_t kReduceBit = 1;
    const size_t kOutOptionsBit = 2;
...
void MapReduceCommandRequest::serialize(const BSONObj& commandPassthroughFields, BSONObjBuilder* builder) const {
...
OpMsgRequest MapReduceCommandRequest::serialize(const BSONObj& commandPassthroughFields) const {
...
BSONObj MapReduceCommandRequest::toBSON(const BSONObj& commandPassthroughFields) const {

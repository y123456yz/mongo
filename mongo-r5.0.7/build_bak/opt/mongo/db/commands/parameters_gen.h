...
class LogLevelServerParameter : public ServerParameter {
public:
...
class LogComponentVerbosityServerParameter : public ServerParameter {
public:
    using ServerParameter::ServerParameter;
...
class AutomationServiceDescriptorServerParameter : public ServerParameter {
public:
    using ServerParameter::ServerParameter;

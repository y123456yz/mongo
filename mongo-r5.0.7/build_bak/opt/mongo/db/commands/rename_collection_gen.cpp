...
RenameCollectionCommand::RenameCollectionCommand(const mongo::NamespaceString commandParameter) : _commandParameter(std::move(commandParameter)), _to(mongo::idl::preparsedValue<decltype(_to)>()), _hasTo(false), _hasDbName(false) {

...
public:
     ...
     */
    const mongo::RWConcernDefault& getRWConcernDefault() const { return _rWConcernDefault; }
    mongo::RWConcernDefault& getRWConcernDefault() { return _rWConcernDefault; }
    void setRWConcernDefault(mongo::RWConcernDefault value) & {  _rWConcernDefault = std::move(value);  }
     ...
     */
    const  boost::optional<mongo::DefaultWriteConcernSourceEnum> getDefaultWriteConcernSource() const { return _rWConcernDefault.getDefaultWriteConcernSource(); }
    /**
     * The source of the default read concern
     */
    const  boost::optional<mongo::DefaultReadConcernSourceEnum> getDefaultReadConcernSource() const { return _rWConcernDefault.getDefaultReadConcernSource(); }
    /**
...
private:
    mongo::RWConcernDefault _rWConcernDefault;

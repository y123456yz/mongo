...
FreeMonRegistrationRequest::FreeMonRegistrationRequest() : _version(mongo::idl::preparsedValue<decltype(_version)>()), _payload(mongo::idl::preparsedValue<decltype(_payload)>()), _localTime(mongo::idl::preparsedValue<decltype(_localTime)>()), _hasVersion(false), _hasPayload(false), _hasLocalTime(false) {
...
FreeMonRegistrationRequest FreeMonRegistrationRequest::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<FreeMonRegistrationRequest>();
...
FreeMonRegistrationResponse::FreeMonRegistrationResponse() : _version(mongo::idl::preparsedValue<decltype(_version)>()), _haltMetricsUploading(mongo::idl::preparsedValue<decltype(_haltMetricsUploading)>()), _id(mongo::idl::preparsedValue<decltype(_id)>()), _informationalURL(mongo::idl::preparsedValue<decltype(_informationalURL)>()), _message(mongo::idl::preparsedValue<decltype(_message)>()), _reportingInterval(mongo::idl::preparsedValue<decltype(_reportingInterval)>()), _hasVersion(false), _hasHaltMetricsUploading(false), _hasId(false), _hasInformationalURL(false), _hasMessage(false), _hasReportingInterval(false) {
    // Used for initialization only
}
...
FreeMonRegistrationResponse FreeMonRegistrationResponse::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<FreeMonRegistrationResponse>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
FreeMonMetricsRequest::FreeMonMetricsRequest() : _version(mongo::idl::preparsedValue<decltype(_version)>()), _id(mongo::idl::preparsedValue<decltype(_id)>()), _localTime(mongo::idl::preparsedValue<decltype(_localTime)>()), _encoding(mongo::idl::preparsedValue<decltype(_encoding)>()), _metrics(mongo::idl::preparsedValue<decltype(_metrics)>()), _hasVersion(false), _hasId(false), _hasLocalTime(false), _hasEncoding(false), _hasMetrics(false) {
    // Used for initialization only
}
...
FreeMonMetricsRequest FreeMonMetricsRequest::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<FreeMonMetricsRequest>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
void FreeMonMetricsRequest::serialize(BSONObjBuilder* builder) const {
    ...
    {
        builder->append(kEncodingFieldName, ::mongo::MetricsEncoding_serializer(_encoding));
    }
...
FreeMonMetricsResponse::FreeMonMetricsResponse() : _version(mongo::idl::preparsedValue<decltype(_version)>()), _haltMetricsUploading(mongo::idl::preparsedValue<decltype(_haltMetricsUploading)>()), _permanentlyDelete(mongo::idl::preparsedValue<decltype(_permanentlyDelete)>()), _reportingInterval(mongo::idl::preparsedValue<decltype(_reportingInterval)>()), _hasVersion(false), _hasHaltMetricsUploading(false), _hasPermanentlyDelete(false), _hasReportingInterval(false) {
    // Used for initialization only
}
...
FreeMonMetricsResponse FreeMonMetricsResponse::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<FreeMonMetricsResponse>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}

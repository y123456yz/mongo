...
AtomicWord<bool> gDiagnosticDataCollectionVerboseTCMalloc;
MONGO_SERVER_PARAMETER_REGISTER(idl_d65e863dd5fd6712a543d4563d77f8c55602d6b9)(InitializerContext*) {
    ...
    /**
     * Enable the capture of verbose tcmalloc in FTDC.
     */
    [[maybe_unused]] auto* scp_8 = ([]() -> ServerParameter* {
        auto* ret = makeIDLServerParameterWithStorage<ServerParameterType::kStartupAndRuntime>("diagnosticDataCollectionVerboseTCMalloc", gDiagnosticDataCollectionVerboseTCMalloc);
        return ret;
    })();

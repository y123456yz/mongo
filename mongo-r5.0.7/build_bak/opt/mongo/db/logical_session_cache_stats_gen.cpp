...
LogicalSessionCacheStats::LogicalSessionCacheStats() : _lastSessionsCollectionJobTimestamp(mongo::idl::preparsedValue<decltype(_lastSessionsCollectionJobTimestamp)>()), _lastTransactionReaperJobTimestamp(mongo::idl::preparsedValue<decltype(_lastTransactionReaperJobTimestamp)>()), _hasLastSessionsCollectionJobTimestamp(false), _hasLastTransactionReaperJobTimestamp(false) {
...
LogicalSessionCacheStats LogicalSessionCacheStats::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<LogicalSessionCacheStats>();

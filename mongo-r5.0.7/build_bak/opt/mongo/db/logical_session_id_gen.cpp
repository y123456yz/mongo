...
LogicalSessionId::LogicalSessionId() : _id(mongo::idl::preparsedValue<decltype(_id)>()), _uid(mongo::idl::preparsedValue<decltype(_uid)>()), _hasId(false), _hasUid(false) {
...
LogicalSessionId LogicalSessionId::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<LogicalSessionId>();
...
LogicalSessionIdToClient::LogicalSessionIdToClient() : _id(mongo::idl::preparsedValue<decltype(_id)>()), _hasId(false) {
    // Used for initialization only
}
...
LogicalSessionIdToClient LogicalSessionIdToClient::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<LogicalSessionIdToClient>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
LogicalSessionToClient::LogicalSessionToClient() : _id(mongo::idl::preparsedValue<decltype(_id)>()), _timeoutMinutes(mongo::idl::preparsedValue<decltype(_timeoutMinutes)>()), _hasId(false), _hasTimeoutMinutes(false) {
    // Used for initialization only
}
...
LogicalSessionToClient LogicalSessionToClient::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<LogicalSessionToClient>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
LogicalSessionRecord::LogicalSessionRecord() : _id(mongo::idl::preparsedValue<decltype(_id)>()), _lastUse(mongo::idl::preparsedValue<decltype(_lastUse)>()), _hasId(false), _hasLastUse(false) {
    // Used for initialization only
}
...
LogicalSessionRecord LogicalSessionRecord::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<LogicalSessionRecord>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
LogicalSessionFromClient::LogicalSessionFromClient() : _id(mongo::idl::preparsedValue<decltype(_id)>()), _hasId(false) {
    // Used for initialization only
}
...
LogicalSessionFromClient LogicalSessionFromClient::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<LogicalSessionFromClient>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
OperationSessionInfo OperationSessionInfo::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<OperationSessionInfo>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
OperationSessionInfoFromClient OperationSessionInfoFromClient::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<OperationSessionInfoFromClient>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
SessionsCollectionFetchResultIndividualResult::SessionsCollectionFetchResultIndividualResult() : __id(mongo::idl::preparsedValue<decltype(__id)>()), _has_id(false) {
    // Used for initialization only
}
...
SessionsCollectionFetchResultIndividualResult SessionsCollectionFetchResultIndividualResult::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<SessionsCollectionFetchResultIndividualResult>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
SessionsCollectionFetchResult::SessionsCollectionFetchResult() : _cursor(mongo::idl::preparsedValue<decltype(_cursor)>()), _hasCursor(false) {
    // Used for initialization only
}
...
SessionsCollectionFetchResult SessionsCollectionFetchResult::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<SessionsCollectionFetchResult>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
SessionsCollectionFetchRequestFilterId SessionsCollectionFetchRequestFilterId::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<SessionsCollectionFetchRequestFilterId>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
SessionsCollectionFetchRequestFilter::SessionsCollectionFetchRequestFilter() : __id(mongo::idl::preparsedValue<decltype(__id)>()), _has_id(false) {
    // Used for initialization only
}
...
SessionsCollectionFetchRequestFilter SessionsCollectionFetchRequestFilter::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<SessionsCollectionFetchRequestFilter>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
SessionsCollectionFetchRequestProjection::SessionsCollectionFetchRequestProjection() : __id(mongo::idl::preparsedValue<decltype(__id)>()), _has_id(false) {
    // Used for initialization only
}
...
SessionsCollectionFetchRequestProjection SessionsCollectionFetchRequestProjection::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<SessionsCollectionFetchRequestProjection>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
SessionsCollectionFetchRequest::SessionsCollectionFetchRequest() : _find(mongo::idl::preparsedValue<decltype(_find)>()), _filter(mongo::idl::preparsedValue<decltype(_filter)>()), _projection(mongo::idl::preparsedValue<decltype(_projection)>()), _batchSize(mongo::idl::preparsedValue<decltype(_batchSize)>()), _singleBatch(mongo::idl::preparsedValue<decltype(_singleBatch)>()), _limit(mongo::idl::preparsedValue<decltype(_limit)>()), _hasFind(false), _hasFilter(false), _hasProjection(false), _hasBatchSize(false), _hasSingleBatch(false), _hasLimit(false) {
    // Used for initialization only
}
...
SessionsCollectionFetchRequest SessionsCollectionFetchRequest::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<SessionsCollectionFetchRequest>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}

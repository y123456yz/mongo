...
static constexpr uint32_t kNumFleAlgorithmEnum = 2;
...
static constexpr uint32_t kNumFleAlgorithmInt = 2;
...
public:
    ...
    EncryptionPlaceholder(mongo::FleAlgorithmInt algorithm, mongo::IDLAnyType value);
     ...
     * value to encrypt
     */
    const mongo::IDLAnyType& getValue() const { return _value; }
    void setValue(mongo::IDLAnyType value) & {  _value = std::move(value); _hasValue = true; }

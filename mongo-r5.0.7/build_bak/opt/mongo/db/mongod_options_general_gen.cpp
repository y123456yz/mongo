...
Status addMongodGeneralOptions(optionenvironment::OptionSection* options_ptr) {
...

    {
        ...
        section
            .addOptionChaining("security.clusterIpSourceAllowlist", "clusterIpSourceAllowlist", moe::StringVector, "Network CIDR specification of permitted origin for `__system` access", {"security.clusterIpSourceWhitelist"}, {"clusterIpSourceWhitelist"}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)

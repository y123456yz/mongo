...
Status addMongodReplicationOptions(optionenvironment::OptionSection* options_ptr) {
...

    {
        ...
        section
            .addOptionChaining("replication.enableMajorityReadConcern", "enableMajorityReadConcern", moe::Bool, "Enables majority readConcern. enableMajorityReadConcern=false is no longer supported", {}, {}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
            .setSources(moe::SourceAll)

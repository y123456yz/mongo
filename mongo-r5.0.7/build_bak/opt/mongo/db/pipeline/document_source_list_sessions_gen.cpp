...
ListSessionsUser::ListSessionsUser() : _user(mongo::idl::preparsedValue<decltype(_user)>()), _db(mongo::idl::preparsedValue<decltype(_db)>()), _hasUser(false), _hasDb(false) {
...
ListSessionsUser ListSessionsUser::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<ListSessionsUser>();
...
ListSessionsSpec ListSessionsSpec::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<ListSessionsSpec>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}

...
ReplaceRootSpec::ReplaceRootSpec() : _newRoot(mongo::idl::preparsedValue<decltype(_newRoot)>()), _hasNewRoot(false) {
...
ReplaceRootSpec ReplaceRootSpec::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<ReplaceRootSpec>();

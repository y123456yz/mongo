...
public:
    ...
    LegacyRuntimeConstants(mongo::Date_t localNow, mongo::Timestamp clusterTime);

    static LegacyRuntimeConstants parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);

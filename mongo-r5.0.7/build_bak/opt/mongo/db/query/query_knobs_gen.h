...
constexpr auto kInternalQueryCacheMaxEntriesPerCollectionDefault = 5000;

extern AtomicWord<int> internalQueryCacheMaxEntriesPerCollection;
constexpr auto kInternalQueryCacheMaxSizeBytesBeforeStripDebugInfoDefault = 512 * 1024 * 1024;

extern AtomicWord<long long> internalQueryCacheMaxSizeBytesBeforeStripDebugInfo;
...
constexpr auto kInternalPipelineLengthLimitDefault = kDebugBuild ? 200 : 1000;

extern int internalPipelineLengthLimit;
...
constexpr auto kInternalQueryEnumerationPreferLockstepOrEnumerationDefault = false;

extern AtomicWord<bool> internalQueryEnumerationPreferLockstepOrEnumeration;
...
constexpr auto kInternalQueryFacetMaxOutputDocSizeBytesDefault = 100 * 1024 * 1024;

extern AtomicWord<long long> internalQueryFacetMaxOutputDocSizeBytes;
...
constexpr auto kInternalDocumentSourceSetWindowFieldsMaxMemoryBytesDefault = 100 * 1024 * 1024;

extern AtomicWord<long long> internalDocumentSourceSetWindowFieldsMaxMemoryBytes;
...
constexpr auto kInternalQueryMaxRangeBytesDefault = 100 * 1024 * 1024;

extern AtomicWord<int> internalQueryMaxRangeBytes;
...
constexpr auto kInternalQueryDefaultDOPDefault = 1;

extern AtomicWord<int> internalQueryDefaultDOP;
constexpr auto kInternalQueryEnableLoggingV2OplogEntriesDefault = true;

extern AtomicWord<bool> internalQueryEnableLoggingV2OplogEntries;
constexpr auto kInternalQuerySlotBasedExecutionMaxStaticIndexScanIntervalsDefault = 1000;

extern AtomicWord<int> internalQuerySlotBasedExecutionMaxStaticIndexScanIntervals;
constexpr auto kInternalQueryEnableCSTParserDefault = false;

extern AtomicWord<bool> internalQueryEnableCSTParser;
constexpr auto kInternalQueryMaxDocValidationErrorConsideredValuesDefault = 10;

extern AtomicWord<int> internalQueryMaxDocValidationErrorConsideredValues;
constexpr auto kInternalQueryExplainSizeThresholdBytesDefault = 10 * 1024 * 1024;

extern AtomicWord<int> internalQueryExplainSizeThresholdBytes;
constexpr auto kInternalQueryEnableSlotBasedExecutionEngineDefault = false;

extern AtomicWord<bool> internalQueryEnableSlotBasedExecutionEngine;
constexpr auto kInternalQueryAppendIdToSetWindowFieldsSortDefault = false;

extern AtomicWord<bool> internalQueryAppendIdToSetWindowFieldsSort;
constexpr auto kEnableSearchMetaDefault = true;

extern AtomicWord<bool> enableSearchMeta;
constexpr auto kEnableTimeoutOfInactiveSessionCursorsDefault = false;

extern AtomicWord<bool> enableTimeoutOfInactiveSessionCursors;
}  // namespace mongo

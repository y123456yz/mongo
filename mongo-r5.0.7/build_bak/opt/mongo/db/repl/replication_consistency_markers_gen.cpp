...
MinValidDocument::MinValidDocument() : _minValidTimestamp(mongo::idl::preparsedValue<decltype(_minValidTimestamp)>()), _minValidTerm(mongo::idl::preparsedValue<decltype(_minValidTerm)>()), _hasMinValidTimestamp(false), _hasMinValidTerm(false) {
...
MinValidDocument MinValidDocument::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<MinValidDocument>();
...
OplogTruncateAfterPointDocument::OplogTruncateAfterPointDocument() : _oplogTruncateAfterPoint(mongo::idl::preparsedValue<decltype(_oplogTruncateAfterPoint)>()), __id(mongo::idl::preparsedValue<decltype(__id)>()), _hasOplogTruncateAfterPoint(false), _has_id(false) {
    // Used for initialization only
}
...
OplogTruncateAfterPointDocument OplogTruncateAfterPointDocument::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<OplogTruncateAfterPointDocument>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
InitialSyncIdDocument::InitialSyncIdDocument() : __id(mongo::idl::preparsedValue<decltype(__id)>()), _has_id(false) {
    // Used for initialization only
}
...
InitialSyncIdDocument InitialSyncIdDocument::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<InitialSyncIdDocument>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}

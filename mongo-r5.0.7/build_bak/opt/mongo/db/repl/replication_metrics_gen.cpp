...
ElectionMetrics::ElectionMetrics() : _stepUpCmd(mongo::idl::preparsedValue<decltype(_stepUpCmd)>()), _priorityTakeover(mongo::idl::preparsedValue<decltype(_priorityTakeover)>()), _catchUpTakeover(mongo::idl::preparsedValue<decltype(_catchUpTakeover)>()), _electionTimeout(mongo::idl::preparsedValue<decltype(_electionTimeout)>()), _freezeTimeout(mongo::idl::preparsedValue<decltype(_freezeTimeout)>()), _hasStepUpCmd(false), _hasPriorityTakeover(false), _hasCatchUpTakeover(false), _hasElectionTimeout(false), _hasFreezeTimeout(false) {
...
ElectionMetrics ElectionMetrics::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<ElectionMetrics>();
...
ElectionCandidateMetrics::ElectionCandidateMetrics() : _lastElectionReason(mongo::idl::preparsedValue<decltype(_lastElectionReason)>()), _lastElectionDate(mongo::idl::preparsedValue<decltype(_lastElectionDate)>()), _electionTerm(mongo::idl::preparsedValue<decltype(_electionTerm)>()), _lastCommittedOpTimeAtElection(mongo::idl::preparsedValue<decltype(_lastCommittedOpTimeAtElection)>()), _lastSeenOpTimeAtElection(mongo::idl::preparsedValue<decltype(_lastSeenOpTimeAtElection)>()), _numVotesNeeded(mongo::idl::preparsedValue<decltype(_numVotesNeeded)>()), _priorityAtElection(mongo::idl::preparsedValue<decltype(_priorityAtElection)>()), _electionTimeoutMillis(mongo::idl::preparsedValue<decltype(_electionTimeoutMillis)>()), _hasLastElectionReason(false), _hasLastElectionDate(false), _hasElectionTerm(false), _hasLastCommittedOpTimeAtElection(false), _hasLastSeenOpTimeAtElection(false), _hasNumVotesNeeded(false), _hasPriorityAtElection(false), _hasElectionTimeoutMillis(false) {
    // Used for initialization only
}
...
ElectionCandidateMetrics ElectionCandidateMetrics::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<ElectionCandidateMetrics>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
void ElectionCandidateMetrics::serialize(BSONObjBuilder* builder) const {
    ...
    {
        builder->append(kLastElectionReasonFieldName, ::mongo::repl::StartElectionReason_serializer(_lastElectionReason));
    }
...
ElectionParticipantMetrics::ElectionParticipantMetrics() : _votedForCandidate(mongo::idl::preparsedValue<decltype(_votedForCandidate)>()), _electionTerm(mongo::idl::preparsedValue<decltype(_electionTerm)>()), _lastVoteDate(mongo::idl::preparsedValue<decltype(_lastVoteDate)>()), _electionCandidateMemberId(mongo::idl::preparsedValue<decltype(_electionCandidateMemberId)>()), _voteReason(mongo::idl::preparsedValue<decltype(_voteReason)>()), _lastAppliedOpTimeAtElection(mongo::idl::preparsedValue<decltype(_lastAppliedOpTimeAtElection)>()), _maxAppliedOpTimeInSet(mongo::idl::preparsedValue<decltype(_maxAppliedOpTimeInSet)>()), _priorityAtElection(mongo::idl::preparsedValue<decltype(_priorityAtElection)>()), _hasVotedForCandidate(false), _hasElectionTerm(false), _hasLastVoteDate(false), _hasElectionCandidateMemberId(false), _hasVoteReason(false), _hasLastAppliedOpTimeAtElection(false), _hasMaxAppliedOpTimeInSet(false), _hasPriorityAtElection(false) {
    // Used for initialization only
}
...
ElectionParticipantMetrics ElectionParticipantMetrics::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<ElectionParticipantMetrics>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}

...
constexpr auto kCreateRollbackDataFilesDefault = true;

extern AtomicWord<bool> gCreateRollbackDataFiles;
constexpr auto kRollbackTimeLimitSecsDefault = 60 * 60 * 24;

extern AtomicWord<int> gRollbackTimeLimitSecs;
}  // namespace mongo

...
public:
    ...
    void getMultikeyComponents() && = delete;
...
public:
     ...
     */
    const StringData getSideWritesTable() const& { return _sideWritesTable; }
    void getSideWritesTable() && = delete;
     ...
     */
    const boost::optional<StringData> getDuplicateKeyTrackerTable() const& { return boost::optional<StringData>{_duplicateKeyTrackerTable}; }
    void getDuplicateKeyTrackerTable() && = delete;
     ...
     */
    const boost::optional<StringData> getSkippedRecordTrackerTable() const& { return boost::optional<StringData>{_skippedRecordTrackerTable}; }
    void getSkippedRecordTrackerTable() && = delete;
     ...
     */
    const boost::optional<StringData> getFileName() const& { return boost::optional<StringData>{_fileName}; }
     ...
     */
    const boost::optional<std::int64_t> getNumKeys() const& { return _numKeys; }
    void getNumKeys() && = delete;
...
public:
    ...
    void getCollectionScanPosition() && = delete;

...
MigrationCoordinatorDocument::MigrationCoordinatorDocument() : _id(mongo::idl::preparsedValue<decltype(_id)>()), _migrationSessionId(mongo::idl::preparsedValue<decltype(_migrationSessionId)>()), _lsid(mongo::idl::preparsedValue<decltype(_lsid)>()), _txnNumber(mongo::idl::preparsedValue<decltype(_txnNumber)>()), _nss(mongo::idl::preparsedValue<decltype(_nss)>()), _collectionUuid(mongo::idl::preparsedValue<decltype(_collectionUuid)>()), _donorShardId(mongo::idl::preparsedValue<decltype(_donorShardId)>()), _recipientShardId(mongo::idl::preparsedValue<decltype(_recipientShardId)>()), _range(mongo::idl::preparsedValue<decltype(_range)>()), _preMigrationChunkVersion(mongo::idl::preparsedValue<decltype(_preMigrationChunkVersion)>()), _hasId(false), _hasMigrationSessionId(false), _hasLsid(false), _hasTxnNumber(false), _hasNss(false), _hasCollectionUuid(false), _hasDonorShardId(false), _hasRecipientShardId(false), _hasRange(false), _hasPreMigrationChunkVersion(false) {
...
MigrationCoordinatorDocument MigrationCoordinatorDocument::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<MigrationCoordinatorDocument>();
...
void MigrationCoordinatorDocument::serialize(BSONObjBuilder* builder) const {
    ...
    if (_decision.is_initialized()) {
        builder->append(kDecisionFieldName, ::mongo::Decision_serializer(_decision.get()));
    }

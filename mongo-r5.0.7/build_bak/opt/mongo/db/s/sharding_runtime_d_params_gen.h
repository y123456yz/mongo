...
constexpr auto kRangeDeleterBatchSizeDefault = std::numeric_limits<int>::max();
...
constexpr auto kReceiveChunkWaitForRangeDeleterTimeoutMSDefault = 10000;

extern AtomicWord<int> receiveChunkWaitForRangeDeleterTimeoutMS;
...
constexpr auto kMaxCatchUpPercentageBeforeBlockingWritesDefault = 10;

extern int maxCatchUpPercentageBeforeBlockingWrites;
...
constexpr auto kMetadataRefreshInTransactionMaxWaitBehindCritSecMSDefault = 500;

extern AtomicWord<int> metadataRefreshInTransactionMaxWaitBehindCritSecMS;
}  // namespace mongo

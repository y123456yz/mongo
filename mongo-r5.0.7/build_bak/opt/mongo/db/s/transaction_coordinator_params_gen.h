...
constexpr auto kCoordinateCommitReturnImmediatelyAfterPersistingDecisionDefault = true;

extern AtomicWord<bool> coordinateCommitReturnImmediatelyAfterPersistingDecision;
}  // namespace mongo

...
Status addBaseServerOptionDefinitions(optionenvironment::OptionSection* options_ptr) {
...

    {
        ...
        section
            .addOptionChaining("systemLog.logAppend", "logappend", moe::Switch, "Append to logpath instead of over-writing", {}, {}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
            .setSources(moe::SourceAll)
        ;

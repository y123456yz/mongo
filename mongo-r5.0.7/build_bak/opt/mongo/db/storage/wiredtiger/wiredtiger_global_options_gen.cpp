...
MONGO_MODULE_STARTUP_OPTIONS_REGISTER(idl_ff0d31d3a91241e3e48b0acf07e7e8553c65eba4)(InitializerContext*) {
...

    {
        ...
        section
            ...
            .addConstraint(new moe::BoundaryKeyConstraint<moe::OptionTypeMap<moe::Double>::type>("storage.wiredTiger.engineConfig.cacheSizeGB", boost::none, boost::none, 0.25, 10000))
        ;
        ...
        section
            .addOptionChaining("storage.wiredTiger.engineConfig.zstdCompressionLevel", "zstdDefaultCompressionLevel", moe::Int, "Default compression level for zstandard compressor", {}, {}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
            .setSources(moe::SourceAll)
            .setDefault(moe::Value(6))
            .addConstraint(new moe::BoundaryKeyConstraint<moe::OptionTypeMap<moe::Int>::type>("storage.wiredTiger.engineConfig.zstdCompressionLevel", boost::none, boost::none, 1, 22))
        ;
...
MONGO_STARTUP_OPTIONS_STORE(idl_ff0d31d3a91241e3e48b0acf07e7e8553c65eba4)(InitializerContext*) {
    ...
    if (params.count("storage.wiredTiger.engineConfig.zstdCompressionLevel")) {
        wiredTigerGlobalOptions.zstdCompressorLevel = params["storage.wiredTiger.engineConfig.zstdCompressionLevel"].as<moe::OptionTypeMap<moe::Int>::type>();
    }

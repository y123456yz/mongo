...
std::int32_t gWiredTigerFileHandleCloseIdleTime{600};
std::int32_t gWiredTigerFileHandleCloseMinimum{250};
std::int32_t gWiredTigerFileHandleCloseScanInterval{10};
bool gWiredTigerSkipTableLoggingChecksOnStartup{false};
MONGO_SERVER_PARAMETER_REGISTER(idl_37c24b9a7239f7fd2d08c68708438c4221821321)(InitializerContext*) {
    ...
    [[maybe_unused]] auto* scp_10 = ([]() -> ServerParameter* {
        auto* ret = makeIDLServerParameterWithStorage<ServerParameterType::kStartupOnly>("wiredTigerSkipTableLoggingChecksOnStartup", gWiredTigerSkipTableLoggingChecksOnStartup);
        return ret;
    })();

...
constexpr auto kWiredTigerFileHandleCloseIdleTimeDefault = 600;
...
constexpr auto kWiredTigerSkipTableLoggingChecksOnStartupDefault = false;

extern bool gWiredTigerSkipTableLoggingChecksOnStartup;
}  // namespace mongo

...
TrafficRecorderStats::TrafficRecorderStats() : _running(mongo::idl::preparsedValue<decltype(_running)>()), _bufferSize(mongo::idl::preparsedValue<decltype(_bufferSize)>()), _bufferedBytes(mongo::idl::preparsedValue<decltype(_bufferedBytes)>()), _recordingFile(mongo::idl::preparsedValue<decltype(_recordingFile)>()), _maxFileSize(mongo::idl::preparsedValue<decltype(_maxFileSize)>()), _currentFileSize(mongo::idl::preparsedValue<decltype(_currentFileSize)>()), _hasRunning(false), _hasBufferSize(false), _hasBufferedBytes(false), _hasRecordingFile(false), _hasMaxFileSize(false), _hasCurrentFileSize(false) {
...
TrafficRecorderStats TrafficRecorderStats::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<TrafficRecorderStats>();
...
StartRecordingTraffic::StartRecordingTraffic() : _filename(mongo::idl::preparsedValue<decltype(_filename)>()), _hasFilename(false), _hasDbName(false) {
    // Used for initialization only
}
...
StartRecordingTraffic StartRecordingTraffic::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<StartRecordingTraffic>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}
...
StopRecordingTraffic StopRecordingTraffic::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<StopRecordingTraffic>();
    object.parseProtected(ctxt, bsonObject);
    return object;
}

...
constexpr auto kTtlMonitorEnabledDefault = true;

extern AtomicWord<bool> ttlMonitorEnabled;
constexpr auto kTtlMonitorSleepSecsDefault = 60;

extern AtomicWord<int> ttlMonitorSleepSecs;
}  // namespace mongo

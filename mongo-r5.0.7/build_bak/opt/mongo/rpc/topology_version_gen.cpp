...
TopologyVersion::TopologyVersion() : _processId(mongo::idl::preparsedValue<decltype(_processId)>()), _counter(mongo::idl::preparsedValue<decltype(_counter)>()), _hasProcessId(false), _hasCounter(false) {
...
TopologyVersion TopologyVersion::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<TopologyVersion>();

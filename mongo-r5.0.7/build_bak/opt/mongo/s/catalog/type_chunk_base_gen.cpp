...
ChunkHistoryBase::ChunkHistoryBase() : _validAfter(mongo::idl::preparsedValue<decltype(_validAfter)>()), _shard(mongo::idl::preparsedValue<decltype(_shard)>()), _hasValidAfter(false), _hasShard(false) {
...
ChunkHistoryBase ChunkHistoryBase::parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject) {
    auto object = mongo::idl::preparsedValue<ChunkHistoryBase>();

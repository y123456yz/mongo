...
AtomicWord<int32_t> gFindChunksOnConfigTimeoutMS{900000};
MONGO_SERVER_PARAMETER_REGISTER(idl_6466812a9192ce7fb46ce034080129dde2b6b3e3)(InitializerContext*) {
    ...
    [[maybe_unused]] auto* scp_1 = ([]() -> ServerParameter* {
        auto* ret = makeIDLServerParameterWithStorage<ServerParameterType::kStartupAndRuntime>("findChunksOnConfigTimeoutMS", gFindChunksOnConfigTimeoutMS);
        return ret;
    })();

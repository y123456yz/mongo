...
class HedgingModeServerParameter : public ServerParameter {
public:
...
constexpr auto kMaxTimeMSForHedgedReadsDefault = 150;

extern AtomicWord<int> gMaxTimeMSForHedgedReads;
constexpr auto kMongosShutdownTimeoutMillisForSignaledShutdownDefault = 15000;

extern AtomicWord<int> mongosShutdownTimeoutMillisForSignaledShutdown;
constexpr auto kLoadBalancerPortDefault = 0;

extern AtomicWord<int> loadBalancerPort;
}  // namespace mongo

...
public:
     ...
     */
    const mongo::OperationSessionInfoFromClient& getOperationSessionInfo() const { return _operationSessionInfo; }
    mongo::OperationSessionInfoFromClient& getOperationSessionInfo() { return _operationSessionInfo; }
    void setOperationSessionInfo(mongo::OperationSessionInfoFromClient value) & {  _operationSessionInfo = std::move(value);  }
...
private:
    mongo::OperationSessionInfoFromClient _operationSessionInfo;

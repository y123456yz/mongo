...
CloneCollectionOptionsFromPrimaryShard::CloneCollectionOptionsFromPrimaryShard(const mongo::NamespaceString commandParameter) : _commandParameter(std::move(commandParameter)), _primaryShard(mongo::idl::preparsedValue<decltype(_primaryShard)>()), _hasPrimaryShard(false), _hasDbName(false) {

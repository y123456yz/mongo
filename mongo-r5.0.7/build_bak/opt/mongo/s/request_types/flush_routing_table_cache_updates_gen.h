...
class FlushRoutingTableCacheUpdates {
public:
    using Reply = void;
    ...
    explicit FlushRoutingTableCacheUpdates(const mongo::NamespaceString commandParameter);

    static FlushRoutingTableCacheUpdates parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);
    static FlushRoutingTableCacheUpdates parse(const IDLParserErrorContext& ctxt, const OpMsgRequest& request);
 ...
 */
class FlushRoutingTableCacheUpdatesWithWriteConcern {
public:
    using Reply = void;
    static constexpr auto kCommandParameterFieldName = "_flushRoutingTableCacheUpdatesWithWriteConcern"_sd;
    static constexpr auto kDbNameFieldName = "$db"_sd;
    static constexpr auto kSyncFromConfigFieldName = "syncFromConfig"_sd;
    static constexpr auto kCommandName = "_flushRoutingTableCacheUpdatesWithWriteConcern"_sd;

    explicit FlushRoutingTableCacheUpdatesWithWriteConcern(const mongo::NamespaceString commandParameter);

    static FlushRoutingTableCacheUpdatesWithWriteConcern parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);
    static FlushRoutingTableCacheUpdatesWithWriteConcern parse(const IDLParserErrorContext& ctxt, const OpMsgRequest& request);
    void serialize(const BSONObj& commandPassthroughFields, BSONObjBuilder* builder) const;
    OpMsgRequest serialize(const BSONObj& commandPassthroughFields) const;
    BSONObj toBSON(const BSONObj& commandPassthroughFields) const;

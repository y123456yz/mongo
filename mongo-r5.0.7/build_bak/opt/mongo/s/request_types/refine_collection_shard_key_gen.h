...
public:
    ...
    static constexpr auto kIsFromPrimaryShardFieldName = "isFromPrimaryShard"_sd;
    static constexpr auto kKeyFieldName = "key"_sd;
    ...
    const boost::optional<bool> getIsFromPrimaryShard() const& { return _isFromPrimaryShard; }
    void getIsFromPrimaryShard() && = delete;
    void setIsFromPrimaryShard(boost::optional<bool> value) & {  _isFromPrimaryShard = std::move(value);  }
...
private:
    ...
    mongo::BSONObj _key;
    mongo::OID _epoch;
    boost::optional<bool> _isFromPrimaryShard;
    std::string _dbName;
    bool _hasKey : 1;
    bool _hasEpoch : 1;
    bool _hasDbName : 1;

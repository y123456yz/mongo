 ...
 */
class ShardsvrShardCollectionRequest {
public:
    ...
    ShardsvrShardCollectionRequest(mongo::BSONObj key);

    static ShardsvrShardCollectionRequest parse(const IDLParserErrorContext& ctxt, const BSONObj& bsonObject);
    void serialize(BSONObjBuilder* builder) const;
    BSONObj toBSON() const;

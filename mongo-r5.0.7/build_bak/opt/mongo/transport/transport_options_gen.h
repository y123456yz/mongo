...
constexpr auto kTcpFastOpenServerDefault = true;

extern bool gTCPFastOpenServer;
constexpr auto kTcpFastOpenQueueSizeDefault = 1024;

extern int gTCPFastOpenQueueSize;
constexpr auto kTcpFastOpenClientDefault = true;

extern bool gTCPFastOpenClient;
}  // namespace transport
}  // namespace mongo

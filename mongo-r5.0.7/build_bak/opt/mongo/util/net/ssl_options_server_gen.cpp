...
MONGO_MODULE_STARTUP_OPTIONS_REGISTER(SSLServerOptionsIDL)(InitializerContext*) {
...

    {
        ...
        section
            .addOptionChaining("net.tls.disabledProtocols", "tlsDisabledProtocols", moe::String, "Comma separated list of TLS protocols to disable [TLS1_0,TLS1_1,TLS1_2,TLS1_3]", {"net.ssl.disabledProtocols"}, {"sslDisabledProtocols"}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
            .setSources(moe::SourceAll)
        ;
        ...
        section
            .addOptionChaining("net.tls.logVersions", "tlsLogVersions", moe::String, "Comma separated list of TLS protocols to log on connect [TLS1_0,TLS1_1,TLS1_2,TLS1_3]", {}, {}, moe::OptionSection::OptionParserUsageType::IDLAutoGeneratedCode)
            .setSources(moe::SourceAll)
        ;
